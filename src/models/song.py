...
class SongMetadata(BaseModel):
    ...
    model_config = ConfigDict(
        json_schema_extra={
            "example": {
                "title": "Peaceful Pregnancy Meditation",
...
class Song(BaseModel):
    ...
    image_uri: Optional[str] = Field(None, description="Cover image or thumbnail URL", examples=["https://example.com/cover-image.jpg"])
    ...
    model_config = ConfigDict(
        json_schema_extra={
            "example": {
                ...
                "metadata": {
                    "title": "Prenatal Relaxation",
                    "artist": "Mindful Motherhood",
                    "duration": 900.0
                }
            }
        }
