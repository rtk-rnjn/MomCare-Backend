...
class FoodItem(BaseModel):
    ...
    """
    name: str = Field(..., title="Food Name", description="Name of the food item", examples=["Grilled Salmon", "Spinach Salad", "Greek Yogurt"])
    ...
    vitamin_contents: List[str] = Field(default_factory=list, description="List of vitamins present", examples=[["Vitamin D", "Vitamin B12", "Omega-3", "Folate"]])
    allergic_ingredients: List[str] = Field(default_factory=list, description="List of potential allergens", examples=[["fish", "dairy", "nuts"]])
