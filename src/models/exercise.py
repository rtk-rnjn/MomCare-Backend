...
class Exercise(BaseModel):
    ...
    week: str = Field(
        ...,
        description="Pregnancy week or postpartum week this exercise is suitable for",
    ...
    model_config: ConfigDict = ConfigDict(
        ...
        json_schema_extra={
            "example": {
                ...
                "duration": 30.0,
                "description": "A gentle yoga sequence designed specifically for pregnant women to improve flexibility, reduce stress, and prepare the body for childbirth.",  # noqa: E501
