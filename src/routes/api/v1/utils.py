...
from .objects import ErrorResponseModel, ServerMessage
...
def _stream(generator):
    return StreamingResponse(generator, media_type="application/x-ndjson", status_code=HTTP_206_PARTIAL_CONTENT)
...
@router.get(
    ...
    responses={
        HTTP_200_OK: {
            "description": "NDJSON stream of food items.",
...
@router.get(
    ...
    responses={
        HTTP_200_OK: {
            "description": "NDJSON stream of songs.",
            "content": {"application/x-ndjson": {}},
        },
    },
)
...
@router.get(
    ...
    responses={
        HTTP_200_OK: {
            "description": "NDJSON stream of exercises.",
            "content": {"application/x-ndjson": {}},
        },
    },
)
